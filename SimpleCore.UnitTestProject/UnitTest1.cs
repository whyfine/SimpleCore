...
namespace SimpleCore.UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            ...
            //var r1 = CoreProvider.Provider.RecordBll.Query("id=@0", new object[] { 1 });
            ...
            //var r2 = CoreProvider.Provider.RecordBll.QueryByParamter(new EntityParamter.RecordParamter() { IdParam = 1});
        }
    }
}
